      ...
      <div className="grid md:grid-cols-2 max-w-4xl w-full bg-white dark:bg-slate-900 rounded-3xl overflow-hidden shadow-2xl border border-slate-200/50 dark:border-slate-800/40 relative z-10 min-h-[500px]">
        ...
        <div className="p-8 md:p-12 flex flex-col justify-center">
          ...
          <p className="text-sm text-slate-400 dark:text-slate-500 mb-8">
            Build consistency. Maintain study, coding, and fitness streaks.
          </p>
          ...
          <div className="mt-4">
            <button
              ...
              className="w-full flex items-center justify-center gap-2 py-3.5 bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-800/80 text-brand-500 dark:text-brand-400 font-semibold rounded-xl text-sm transition-all cursor-pointer"
            >
        ...
        <div className="hidden md:flex flex-col justify-between p-12 bg-gradient-to-tr from-brand-600 to-indigo-950 text-white relative">
          ...
          <div className="relative z-10 space-y-6">
            ...
            <div>
              ...
              <cite className="block mt-3 text-sm text-indigo-200 not-italic font-medium">— John Dryden</cite>
            </div>
          </div>
